...
#define MOTOSPD 7499            //30k tic corrasponds to 25ms period 400Hz
...
#define CLOSE 1010              //closed duty cycle
#define OPEN 3000               //open duty cycle
...
void releTimer(void);           //release timer function
